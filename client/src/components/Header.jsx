        ...
        {user ? (
            ...
            >
              ...
              {isMenu && (
                <motion.div
                  ...
                  className="px-6 py-4 bg-white opacity-40 backdrop-blur-md rounded-md shadow-md absolute top-12 right-0 flex flex-col gap-4 w-48"
                >
                  {user?.user_id === process.env.REACT_APP_ADMIN_ID && (
                    <Link
                      className="hover:text-red-500 text-xl text-gray-400"
                      to={"/dashboard/home"}
                    >
                      Dashboard
                    </Link>
                  ...
                  >
                    <MdLogout className="tex-2xl text-textColor group-hover::text-headingColor" />
          ...
          <>
            <NavLink to={"/login"}>
              <motion.button
                {...buttonClick}
                className="px-4 py-2 rounded-md shadow-md bg-gray-50 border border-red-300 cursor-pointer"
              >
                Login
              </motion.button>
            </NavLink>
