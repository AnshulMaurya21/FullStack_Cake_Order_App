  ...
  return (
    <div className="flex items-center justify-center flex-col pt-6 px-24 w-full">
      <div className="border border-gray-300 rounded-md p-4 w-full flex flex-col items-center justify-center gap-4">
        ...
        <div className="w-full bg-card backdrop-blur-sm h-370 rounded-md border-2 border-dotted border-gray-300 cursor-pointer">
          {isLoading ? (
                ...
                <>
                  <div className="relative w-full h-full overflow-hidden rounded-md">
                    ...
                    <motion.button
                      {...buttonClick}
                      type="button"
                      className=" absolute top-3 right-3 cursor-pointer outline-none hover:shadow-md duration-500 transition-all ease-in-out"
