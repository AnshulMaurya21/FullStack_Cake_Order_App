  ...
  return (
    <div className="w-full flex items-center justify-between gap-3">
      ...
      <div className="flex items-center justify-center gap-4">
        <div className="flex items-center justify-center gap-3 px-4 py-2 bg-slate-50 backdrop-blur-md rounded-md shadow-md">
        ...
        <motion.div
          {...buttonClick}
          className="w-10 h-10 rounded-md cursor-pointer bg-slate-50 backdrop-blur-md shadow-md flex items-center justify-center"
        >
